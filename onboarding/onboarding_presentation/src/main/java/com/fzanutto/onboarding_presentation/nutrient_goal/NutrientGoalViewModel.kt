package com.fzanutto.onboarding_presentation.nutrient_goal
...
import com.fzanutto.onboarding_domain.use_case.ValidateNutrients
            ...
            is NutrientGoalEvent.OnNextClick -> {
                ...
                when (result) {
                    is ValidateNutrients.Result.Success -> {
                        preferences.saveFatRatio(result.fatRatioText)
                        preferences.saveCarbRatio(result.carbsRatioText)
                        preferences.saveProteinRatio(result.proteinRatioText)
