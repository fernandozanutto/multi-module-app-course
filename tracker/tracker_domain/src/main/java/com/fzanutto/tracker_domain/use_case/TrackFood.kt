...
class TrackFood(
    ...
    suspend operator fun invoke(
        ...
        return repository.insertTrackedFood(
            TrackedFood(
                name = food.name,
                carbs = ((food.carbsPer100g / 100.0) * amount).roundToInt(),
                fat = ((food.fatPer100g / 100.0) * amount).roundToInt(),
                protein = ((food.proteinPer100g / 100.0) * amount).roundToInt(),
                calories = ((food.caloriesPer100g / 100.0) * amount).roundToInt(),
