...
import com.fzanutto.core.domain.model.Gender
import com.fzanutto.core.domain.model.GoalType
import com.fzanutto.core.domain.model.UserInfo
...
class CalculateMealNutrients(
    ...
    operator fun invoke(trackedFoods: List<TrackedFood>): Result {
        ...
        val carbsGoal = (caloryGoal * userInfo.carbRatio / 4f).roundToInt() // 1g of fat has 4kcal
        val proteinGoal = (caloryGoal * userInfo.proteinRatio / 4f).roundToInt() // 1g of protein has 4kcal
        val fatGoal = (caloryGoal * userInfo.fatRatio / 9f).roundToInt() // 1g of fat has 9kcal
